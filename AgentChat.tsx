...
await new Promise(resolve => setTimeout(resolve, 1000));
      ...
      const agentInfo = getAgentInfo(input); // Kullanıcı girdisine göre ajanı seç
      
      const assistantMessage: Message = {
        id: (Date.now() + 1).toString(),
        role: 'assistant',
        content: `**Analiz Tamamlandı:** "${input}" talebiniz hibrit doğrulama sistemimiz tarafından inceleniyor. Şimdilik sistem simülasyon modundadır.`,
        timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
